...
from services.statistics import bootstrap_confidence_intervals, pairwise_pnl_test
...
def test_statistics_helpers_return_finite_values():
    ...
    test = pairwise_pnl_test([1, 2, 3], [0.5, 1.5, 2.5], comparisons=3)
    ...
    assert math.isfinite(test.corrected_p_value)
    assert test.n == 3
